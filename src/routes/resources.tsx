...
function ResourcesPage() {
  ...
  return (
    <AppShell title="Edukasi & Insights Center" subtitle="Panduan sistem deteksi fraud · modus penipuan · teknologi SAFER">
      
      {/* ─── Top Welcome Section ─── */}
      <div className="rounded-lg border border-border bg-card p-6 mb-6">
        <h3 className="text-lg font-bold text-foreground flex items-center gap-2">
          <BookOpen className="h-5 w-5 text-primary" /> Pusat Pengetahuan Fraud Intelligence
        </h3>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] uppercase font-bold text-primary">{article.category}</span>
          ...
          <div className="rounded-lg border border-border bg-card p-6 md:p-8">
            ...
            <div className="border-b border-border pb-4 mb-6">
              <div className="flex items-center gap-2 text-xs">
                <span className="bg-primary/20 text-primary font-bold px-2 py-0.5 rounded uppercase">{activeArticle.category}</span>
