...
function InvestorPage() {
  ...
  const handleConsultSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send to proxy leads endpoint with investor tag
  ...
  return (
    <AppShell title="Investor & Growth Relations" subtitle="Portal Khusus Investor & Mitra Strategis SAFER">
      <div className="space-y-8 pb-12">
        
        {/* ─── Hero Header & Pitch Banner ─── */}
        <div className="relative overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-card via-card/90 to-primary/10 p-6 md:p-8 shadow-xl">
          ...
          <div className="relative z-10 space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
              <Sparkles className="h-3.5 w-3.5" /> Standalone Investor Portal · Confidential Pitching Brief
            </div>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg hover:bg-primary/90 transition-all hover:scale-[1.02]"
              >
                <MessageSquare className="h-4 w-4" /> Hubungi & Konsultasi Tim SAFER <ArrowUpRight className="h-4 w-4" />
              </button>
              
              <a
                href="https://api.safer.web.id/docs"
                target="_blank"
                rel="noreferrer"
              ...
              >
                <FileText className="h-4 w-4 text-muted-foreground" /> OpenAPI Docs (Swagger)
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {[
            ...
            return (
              <div key={i} className="rounded-xl border border-border bg-card/60 p-5 backdrop-blur-md shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-card p-6 space-y-4">
            ...
            <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/10 p-3.5 text-xs text-emerald-300">
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5 space-y-3">
              ...
              <div className="text-[11px] font-mono text-purple-300 bg-purple-500/10 p-2 rounded">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5 space-y-3">
              ...
              <div className="text-[11px] font-mono text-cyan-300 bg-cyan-500/10 p-2 rounded">
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-primary/30 bg-primary/5 p-5 space-y-3">
              <div className="text-xs font-semibold text-primary uppercase tracking-wider">ROI Klien (Tier Business)</div>
              <div className="text-2xl font-extrabold text-foreground">&gt; 1.000% ROI</div>
              <p className="text-xs text-muted-foreground">
                Asumsi fraud Rp 500 Juta/bln. Hemat fraud Rp 3 Miliar/thn + efisiensi staf Rp 120 Juta/thn = Benefit Rp 3,12 Miliar vs Investasi Rp 280 Juta.
              </p>
            ...
            <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/5 p-5 space-y-3">
              <div className="text-xs font-semibold text-cyan-400 uppercase tracking-wider">Break-Even Point (BEP)</div>
            ...
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-5 space-y-3">
              <div className="text-xs font-semibold text-emerald-400 uppercase tracking-wider">ROI Investor (Tahun 1)</div>
          ...
          <div className="overflow-x-auto rounded-lg border border-border">
            <table className="w-full text-left text-xs">
              <thead className="bg-muted/50 text-muted-foreground font-semibold uppercase tracking-wider">
                <tr>
                  <th className="px-4 py-3">Tier Skema</th>
                  <th className="px-4 py-3">Target Segmen</th>
                  <th className="px-4 py-3">Volume Kuota / Bulan</th>
                  <th className="px-4 py-3">Harga Langganan</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border text-foreground">
                <tr>
                  <td className="px-4 py-3 font-semibold text-primary">Tier Starter</td>
                  <td className="px-4 py-3">Fintech Rintisan / Payment Gateway Awal</td>
                  <td className="px-4 py-3">&lt; 500 Ribu Transaksi</td>
                  <td className="px-4 py-3 font-mono">Rp 5 Juta / Bulan</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-cyan-400">Tier Business</td>
                  <td className="px-4 py-3">Fintech Menengah / E-Wallet & Payment Switch</td>
                  <td className="px-4 py-3">&lt; 5 Juta Transaksi</td>
                  <td className="px-4 py-3 font-mono">Rp 15 Juta / Bulan</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-purple-400">Tier Enterprise</td>
                  <td className="px-4 py-3">Bank Umum BUKU 3 & 4 / Lembaga Keuangan Besar</td>
                  <td className="px-4 py-3">Volume Kustom Tak Terbatas</td>
                  <td className="px-4 py-3 font-mono">Rp 50 Juta / Bulan</td>
                </tr>
                <tr className="bg-accent/30">
                  <td className="px-4 py-3 font-semibold text-emerald-400">On-Premise Setup Fee</td>
                  <td className="px-4 py-3">Kepatuhan Data Residency / Air-Gapped Environment</td>
                  <td className="px-4 py-3">Instalasi, Kustom Model & Training Analis</td>
                  <td className="px-4 py-3 font-mono">Rp 100 Juta (One-time)</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          {/* Disclaimer Box */}
          <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4 text-xs text-amber-300 space-y-1">
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-lg border border-border bg-card/50 p-4 space-y-2">
              ...
              <div className="text-xs font-semibold text-primary">AI Architect & Project Manager Lead</div>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-4 space-y-2">
              ...
              <div className="text-xs font-semibold text-purple-400">UI/UX & Business Domain Lead</div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Merancang sistem desain dashboard, alur investigasi analis, visualisasi Fraud Graph, dan pengujian usability. Memimpin kepatuhan regulasi (BI, OJK, PPATK) berbasis human-in-the-loop, skema B2B SaaS, dan asosiasi ASPI.
              </p>
            </div>
          ...
          <div className="rounded-lg border border-border bg-card/80 p-4 space-y-2 text-xs">
        ...
        <div className="rounded-2xl border border-primary/40 bg-gradient-to-r from-primary/10 via-card to-purple-500/10 p-6 md:p-8 text-center space-y-4 shadow-xl">
          <Award className="h-10 w-10 text-primary mx-auto" />
          <h2 className="text-2xl font-bold text-foreground">Tertarik Berdiskusi atau Berinvestasi di SAFER?</h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <button
              onClick={() => setIsConsultModalOpen(true)}
              className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-bold text-primary-foreground shadow-lg hover:bg-primary/90 transition-all hover:scale-105"
            >
              <Send className="h-4 w-4" /> Formulir Konsultasi Investor
            </button>
            <a
              href="mailto:akbarfadhila@gmail.com?subject=Inquiry%20Investor%20SAFER%20FDS"
              className="inline-flex items-center gap-2 rounded-lg border border-border bg-card px-5 py-3 text-sm font-semibold text-foreground hover:bg-accent transition-colors"
            >
              <Mail className="h-4 w-4 text-muted-foreground" /> Email Langsung Tim
            </a>
          </div>
        </div>
      ...
      {isConsultModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-lg rounded-2xl border border-primary/30 bg-card shadow-2xl p-6 overflow-hidden max-h-[90vh] overflow-y-auto">
            <button 
            ...
            {!submitted ? (
              <form onSubmit={handleConsultSubmit} className="space-y-4">
                <div className="text-center pb-2">
                  ...
                  <h3 className="text-lg font-bold text-foreground">Konsultasi & Inquiry Investor SAFER</h3>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary py-2.5 text-xs font-bold text-primary-foreground shadow-md hover:bg-primary/90 transition-all disabled:opacity-50"
                >
                  {submitting ? (
                    <>
