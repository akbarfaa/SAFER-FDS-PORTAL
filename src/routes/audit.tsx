...
function AuditPage() {
  ...
  // Keep selected tx in sync with store
  useEffect(() => {
    if (selectedTx) {
                    ...
                    >
                      <td className="px-4 py-2.5">
                        <input
                          ...
                          onChange={() => toggleSelect(t.raw.id)}
                          className="rounded accent-primary"
                        />
                      </td>
                      ...
                      <td className="px-4 py-2.5">
                        <button onClick={() => setSelectedTx(t)} className="font-mono text-xs text-primary hover:underline">
                          {t.raw.id}
                        </button>
                      </td>
                      ...
                      <td className="px-4 py-2.5">
                        <select
                          value={t.auditStatus}
                          onChange={(e) => actions.updateAuditStatus(t.raw.id, e.target.value as AuditStatus)}
